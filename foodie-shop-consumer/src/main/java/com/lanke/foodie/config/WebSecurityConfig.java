...
//
//import com.lanke.foodie.config2.CasProperties;
//import com.lanke.foodie.config2.CustomUserDetailsService;
...
//				.and().formLogin().defaultSuccessUrl("/common/gotoAdmin"); // 登录成功之后的跳转
//
